...
provider "proxmox" {
  ...
  pm_api_token_id     = data.vault_generic_secret.pm_api_token_id.data["TF_USERNAME"]
  pm_api_token_secret = data.vault_generic_secret.pm_api_token_secret.data["TF_TOKEN"]
